  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-pepe-warm-white rounded-2xl shadow-warm-lg max-w-md w-full p-6 animate-scale-in" onClick={e => e.stopPropagation()}>
          {/* Icon */}
          <div className="text-center mb-4">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-pepe-orange/20 text-pepe-burnt-orange mb-3">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
            </div>
            <h3 className="font-oswald text-2xl font-bold text-pepe-dark tracking-wide">
              HAVE ENOUGH FOOD?
            </h3>
          </div>
          ...
          {/* Coverage Info */}
          <div className="mb-6">
            <p className="text-center text-pepe-charcoal/70 mb-4">
              Your order covers <strong className="text-pepe-dark">{coverage}%</strong> of {state.headcount} guests
            </p>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={onContinue}
              className="w-full text-sm text-muted hover:text-pepe-dark transition-colors py-2"
            >
              Continue anyway
            </button>
          </div>
