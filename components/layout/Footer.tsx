      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <span className="font-oswald text-3xl text-[#E8A317] tracking-wide">
              PEPE&apos;S
            </span>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-oswald text-lg font-semibold text-[#C8102E] mb-4 tracking-wide">
              QUICK LINKS
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+17087553555" className="hover:text-white transition-colors">
                  (708) 755-3555
                </a>
              </li>
              <li className="flex items-center gap-2">
