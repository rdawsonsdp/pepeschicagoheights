    ...
    <footer>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href={siteConfig.social.facebook || '#'} className="text-white/50 hover:text-white transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/>
                </svg>
              </a>
              <a href={siteConfig.social.instagram || '#'} className="text-white/50 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-xs text-white/40">
              {siteConfig.content.deliveryNotes.map((note, i) => (
                <span key={i}>{note}{i < siteConfig.content.deliveryNotes.length - 1 && <br />}</span>
              ))}
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-pepe-orange/10 mt-8 pt-8 text-center text-sm text-white/40">
          <p>&copy; {currentYear} {siteConfig.content.copyrightText}</p>
          <p className="mt-4 text-xs text-white/30">
            Powered by{' '}
            <a href={siteConfig.platform.url} target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
              {siteConfig.platform.name}
            </a>
          </p>
        </div>
      </div>
