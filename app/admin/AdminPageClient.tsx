...
export default function AdminPageClient({ products }: { products: CateringProduct[] }) {
  return (
      ...
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        ...
        <div className="grid gap-4">
          ...
          >
            ...
            <p className="text-gray-500 text-sm">View and manage catering orders</p>
          </Link>
          ...
          <Link
            ...
            className="block bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:border-pepe-orange hover:shadow-md transition-all"
          >
            <h2 className="text-xl font-semibold text-gray-900 mb-1">Analytics</h2>
            <p className="text-gray-500 text-sm">View visitor stats, conversion funnels, and order data</p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-500 text-sm">Email notifications, category visibility, and business rules</p>
          </Link>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                onClick={() => exportCateringMenuPDF(products)}
              ...
              <button
                onClick={() => exportMenuXLS(products)}
