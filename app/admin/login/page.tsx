      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 w-full max-w-sm text-center">
        ...
        {error === 'unauthorized' && (
          <div className="bg-red-50 border border-red-200 text-red-700 text-sm rounded-lg px-4 py-3 mb-6">
            Your Google account is not authorized to access admin. Contact the site owner to request access.
          </div>
        )}
        ...
        <button
          onClick={() => signIn('google', { callbackUrl: '/admin/menu-engineering' })}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl font-semibold text-sm text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-[0.98]"
        >
