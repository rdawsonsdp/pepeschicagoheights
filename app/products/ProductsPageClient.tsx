...
export default function ProductsPageClient({ products }: { products: CateringProduct[] }) {
  ...
  return (
    <div className="min-h-screen bg-pepe-cream">
      ...
      <div className="bg-pepe-dark py-8 sm:py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-pepe-sand text-lg font-crimson italic">
            Browse all {products.length} items from our catering menu
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <HeroItemsSection products={products} mode="order" />
