          ...
          {DESSERTS.map((item) => (
            <div key={item.name} className="py-6 border-b border-pepe-menu-cream/20 last:border-b-0">
              ...
              <div className="flex justify-between items-start gap-4">
                <div>
                  <h3 className="font-oswald font-bold text-pepe-menu-cream tracking-wide text-2xl sm:text-3xl">
                    {item.name}
                  </h3>
                  {item.description && (
                ...
                <span className="font-oswald font-bold text-pepe-menu-cream whitespace-nowrap text-2xl sm:text-3xl">
                  {item.price}
                </span>
              </div>
            </div>
